package dev.gaphunter.backgroundreadactionfreezecompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.backgroundreadactionfreezecompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.backgroundreadactionfreezecompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Background ReadAction Freeze Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/34085-background-readaction-freeze-companion/reviews"
